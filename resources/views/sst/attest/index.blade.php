                ...
                <div class="card mt-4 mb-4 border-light shadow">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3>
                            ...
                            {{ $search->total() }} Fichas de atestados
                        </h3>

                        <div class="d-flex align-items-center">
                            <div>
                                <button type="button">
                                    <a href="{{ route('sst.attest.create') }}" class="btn btn-success text-light">
                    ...
                    <div class="card-body">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('sst.attest.index') }}">
                                        ...
                                        <div class="text-center">
                                            <button type="button">
                                                <a href="{{ route('sst.attest.index') }}" class="btn btn-warning btn-sm text-dark">
                        ...
                        <table class="table text-center">
                            ...
                            <tbody>
                                @forelse ($search as $attests)
                                    <tr>
                                        <th>{{ $attests->employee->code }}</th>
                                        <td>{{ $attests->employee->name }}</td>
                                        <td>{{ $attests->employee->adjuntancy }}</td>
                                        <td>{{ $attests->detail->count() }}</td>
                                        <td class="d-md-flex justify-content-center">
                                            <button type="button">
                                                <a href="{{ route('sst.attest.show', $attests->id) }}" class="btn btn-secondary text-light mr-2">
                                                    <i class="fa-solid fa-eye"></i> Ver
                                                </a>
                                            </button>

                                            <form action="{{ route('sst.attest.edit', $attests->id) }}" method="GET" class="mr-2">
                                                @csrf
                                            ...
                                            <form action="{{ route('sst.attest.destroy', $attests->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
