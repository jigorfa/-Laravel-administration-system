                        ...
                        <div class="d-flex justify-content-center">
                            <div class="col-md-9">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="delay_date" class="form-control-label">Data do atraso *</label>
                                        <input type="date" id="delay_date" name="delay_date" placeholder="Insira a data do atraso do(a) funcionário(a): " class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="arrival" class="form-control-label">Hora da chegada *</label>
                                        <input type="time" id="arrival" name="arrival" placeholder="Insira a hora da chegada do(a) funcionário(a): " class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="leave" class="form-control-label">Hora da saída *</label>
                                        <input type="time" id="leave" name="leave" placeholder="Insira a hora da saída do(a) funcionário(a): " class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="motive" class="form-control-label">Motivo do atraso *</label>
                                        <input type="text" id="motive" name="motive" placeholder="Insira o motivo do atraso do(a) funcionário(a): " class="form-control">
                                    </div>
